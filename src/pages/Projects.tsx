  ...
  const projects = [
    {
      ...
      description: "Built a multi-agent AI system that analyzes stocks, news, and financial data to generate explainable investment insights with structured reasoning, risk evaluation, and continuous learning loops.",
      image: "https://images.unsplash.com/photo-1642790106117-e829e14a795f?w=600&h=400&fit=crop",
      technologies: ["Python", "Flask", "LangGraph", "LLM APIs", "PostgreSQL", "Redis", "Docker", "AWS", "React"],
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            A collection of projects showcasing my work across AI agents, full-stack web apps, Spring Boot systems, and machine learning
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="glass-3d tilt-card rounded-xl overflow-hidden transition-all duration-300 group">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="absolute top-4 right-4 depth-chip bg-purple-500/80 text-white px-3 py-1 rounded-full text-xs">
                  {project.duration}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech) => (
                    <span key={tech} className="depth-chip px-2 py-1 bg-purple-500/20 text-purple-300 rounded-md text-xs">
                      {tech}
                    </span>
                  ))}
                </div>
